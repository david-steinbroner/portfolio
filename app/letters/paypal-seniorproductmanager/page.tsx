      ...
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-foreground mb-4">
            I spent four years making the infrastructure disappear.
          </h1>
        ...
        <article className="space-y-6 text-foreground-secondary leading-relaxed mb-12">
          ...
          <p>
            ...
            , from 4+ weeks to days, multiple blocked roadmap items moved forward, and Fold's relationship with its partners went from reactive to trusted. Compliance stopped being a bottleneck and became a checkpoint we designed around from the start.
          </p>
