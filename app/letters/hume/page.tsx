    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <article className="space-y-6 text-foreground-secondary leading-relaxed mb-12">
          ...
          <p>
            The last piece of the puzzle for AI to really integrate into daily life - commercially and personally - is the emotional layer. That's what Hume is solving for. To successfully use AI as a tool for humans, it needs to keep reaching toward where humans actually are, and that's at an emotional level. That's what makes Hume's position so compelling and so defensible.
          </p>

          <p>
            I've also seen this exact market dynamic before. At Fold, Bitcoin was the underlying technology and there were a million companies racing to capture market share on top of it. We didn't invent Bitcoin - it was already there. We had to stand out, and since there were so many options, even standing out wasn't enough. The first experience, the onboarding, everything had to be incredibly smooth, because otherwise people would immediately bail for another option. Same with AI. AI is already everywhere. Hume is built on its rails. Hume is the onramp for a specific, powerful use case - and in a crowded market, it needs to stand out and carve out space for itself.
          </p>

          <p>I signed up. I explored the product. Here's what I'd be thinking about on day one.</p>

          <h2 className="text-xl font-semibold text-foreground pt-4">What I see when I look at Hume right now</h2>
          ...
          <p>
            <strong>Days 1-30: Move fast, learn everything.</strong> I don't need to wait for perfect data to start. I can hit the ground running with engagement levers on social media in the first week - Reddit presence, Twitter engagement, community conversations. These cost nothing, generate signal immediately, and start building the feedback loops I'll need later.
          </p>

          <p>
            At the same time, I'm immersing in the product - understanding it the way a user does, the way a creator does, the way a developer does. Where do I get stuck? Where do I get excited? Where do I drop off? I'm running user studies from the start - credits in exchange for interviews with new users. And I'm learning the business: every metric we're tracking, the full funnel, channel attribution, affiliate performance, what's on the roadmap, what's been tried before, and what the results were.
          </p>
          ...
          <p>
            <strong>Days 30-60: Build the engine.</strong> By now I have a clear picture of the funnel, the gaps, and where the highest-leverage opportunities are. I'm running experiments - activation flow changes, onboarding improvements, content and messaging tests across channels. I'm standing up the tracking and attribution infrastructure needed to measure what's working. I'm building the community feedback loops that will become a permanent part of how growth and product talk to each other.
          </p>

          <p>
            <strong>Days 60-90: Scale what works.</strong> The early experiments have data. I know which channels convert, which messages resonate, which parts of the funnel are leaking. Now it's about doubling down on what's working, cutting what isn't, and presenting a growth strategy to leadership that's backed by real results, not projections. By day 90, there should be a repeatable growth playbook taking shape - not finished, but running.
          </p>

          <h2 className="text-xl font-semibold text-foreground pt-4">How I know how to do this</h2>

          <p>
            I spent four years at Fold as one of a team of 11 that took it to the Nasdaq - the first Bitcoin-only company to do so.
          </p>
          ...
          <p>
            I managed our app store presence and moved our rating from 3.6 to 4.3 across both stores. I led the rebrand of our website. I turned our biggest engagement lever - the Spin Wheel, the darling of Fold - from a cost center into six-figure revenue. I created Friends of Fold, a power user group that became our product feedback loop, our QA team, and our most vocal advocates.
          </p>
          ...
          <h2 className="text-xl font-semibold text-foreground pt-4">I build with AI every day</h2>

          <p>
            In mid-2023, I built an internal chatbot for our team at Fold - a tool that could reference what was happening across every department, surface past decisions and their reasoning, and make us more productive. It was my first foray into building with AI. Since then I've been building web and mobile apps using AI-assisted development - some with AI agents as part of the UX, like my mobile-first AI tabletop RPG. I use Claude Code as my primary development tool with proper engineering workflows - GitHub, feature branches, CI/CD, monitoring. I'm not a PM who hands off specs and waits. I build, ship, measure, and iterate.
          </p>

          <h2 className="text-xl font-semibold text-foreground pt-4">What I actually need from you</h2>
